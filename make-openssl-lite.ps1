...
$perl_x86_command = "perl Configure VC-WIN32 no-docs no-legacy no-tests no-shared --prefix=" + $directory_x86_release;
...
$perl_x64_command = "perl Configure VC-WIN64A no-docs no-legacy no-tests no-shared --prefix=" + $directory_x64_release;
